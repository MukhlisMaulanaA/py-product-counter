...
cv2.namedWindow("Kamera Conveyor")
cv2.setMouseCallback("Kamera Conveyor", deteksi_klik_mouse)
...
while True:
    ...
    # Berhenti jika video habis atau tombol exit diklik
    ...
    cv2.imshow("Kamera Conveyor", frame)
